---
title: "Lecture 4: Comparison and Logical Operators in R"
...
Extra: If one sets `T <- FALSE`, or vice versa, the logical values will be updated for the these variables! Do not do this in practice, as it can lead to confusion... And do not be mean to other programmers! ;)
